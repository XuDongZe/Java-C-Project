...
public class ClientWindow extends JFrame{
	...
	public static void main(String[] args) {
		try {
		    ...
		    WebLookAndFeel.globalTooltipFont = new FontUIResource("宋体", 0, 12);
		    WebLookAndFeel.globalAlertFont = new FontUIResource("宋体", 0, 12);
		    WebLookAndFeel.globalMenuFont = new FontUIResource("宋体", 0, 12);
	        WebLookAndFeel.globalAcceleratorFont = new FontUIResource("宋体", 0, 12);
	        WebLookAndFeel.globalTitleFont = new FontUIResource("宋体", 0, 12);
	        WebLookAndFeel.globalTextFont = new FontUIResource("宋体", 0, 12);
